...
import com.mvc.modelo.Persona;
import com.mvc.modelo.PersonaDAO;
import com.mvc.vista.vista;
...
public class Controlador implements ActionListener {
    ...
    public void delete() {
        int fila = vista.tabla.getSelectedRow();
        if (fila == -1) {
            JOptionPane.showMessageDialog(vista, "No hay elemento seleccionado...!!!");
        } else {
            int id = Integer.parseInt((String) vista.tabla.getValueAt(fila, 0).toString());
            dao.Delete(id);
            System.out.println("El Reusltaod es" + id);
            JOptionPane.showMessageDialog(vista, "Usuario Eliminado con exito...!!!");
        }
        limpiarTabla();
    }
    ...
    public void Actualizar() {
        if (vista.txtId.getText().equals("")) {
            JOptionPane.showMessageDialog(vista, "No se Identifica elemento, selecionar la opcion Editar");
        } else {
