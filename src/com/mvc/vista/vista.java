...
public class vista extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        btnAgregar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/config/salvar.png"))); // NOI18N
        ...
        btnListar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/config/lista.png"))); // NOI18N
        btnListar.setText("LISTAR");

        btnDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/config/basura.png"))); // NOI18N
        btnDelete.setText("DELETE");

        btnActualizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/config/actualizado.png"))); // NOI18N
        ...
        btnEditar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/config/editar.png"))); // NOI18N
        btnEditar.setText("EDITAR");

        btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/config/agregar.png"))); // NOI18N
